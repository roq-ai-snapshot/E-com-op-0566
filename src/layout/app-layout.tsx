...
const LinkItems: Array<LinkItemProps> = [
  ...
  {
    name: 'abandoned_cart_item',
    path: '/abandoned-cart-items',
  ...
  {
    name: 'customer_segment_member',
    path: '/customer-segment-members',
    entity: 'customer_segment_member',
    service: AccessServiceEnum.PROJECT,
    icon: FiHome,
  },
  { name: 'inventory', path: '/inventories', entity: 'inventory', service: AccessServiceEnum.PROJECT, icon: FiHome },
  { name: 'order', path: '/orders', entity: 'order', service: AccessServiceEnum.PROJECT, icon: FiHome },
  { name: 'order_item', path: '/order-items', entity: 'order_item', service: AccessServiceEnum.PROJECT, icon: FiHome },
  {
  ...
  { name: 'store', path: '/stores', entity: 'store', service: AccessServiceEnum.PROJECT, icon: FiHome },
